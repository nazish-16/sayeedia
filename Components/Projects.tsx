        ...
        <>
            ...
            <div className='flex flex-col lg:flex-row items-center justify-center'>
                <div className='grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-4 m-12 lg:m-0'>
                    ...
                    <img src="https://scontent.fhyd1-6.fna.fbcdn.net/v/t39.30808-6/340099741_768840387890396_4804474800380608412_n.jpg?_nc_cat=111&ccb=1-7&_nc_sid=833d8c&_nc_ohc=6FmKNipfaDYQ7kNvgH5dCtV&_nc_ht=scontent.fhyd1-6.fna&oh=00_AYBrJcidn9oRwlTE8tI0wJR7kxyPPjL2AwRJtf4WWR503g&oe=668C3840" width={250} className='m-5 rounded-lg hover:scale-105 transition-transform' />
                </div>
            </div>
        </>
    )
