    ...
    return (
        <>
            ...
            <div className='flex flex-col lg:flex-row items-center justify-center'>
                <div className='grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 m-12 lg:m-0'>
                    <img src="https://images-ext-1.discordapp.net/external/_OZoLx0SVUvOnwUd9mLc_9j0sg4bq0Y_0RVhnwswRfc/https/www.curtainlabel.com/wp-content/uploads/2022/12/75380300_111228216994825_3332626362333659136_n-2.jpg?format=webp&width=531&height=676" width={250} className='m-5 rounded-lg hover:scale-105 transition-transform' />
