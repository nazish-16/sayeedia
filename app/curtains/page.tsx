                ...
                <div className='flex flex-col items-center justify-center p-7'>
                    ...
                    <div className='flex justify-between items-center'>
                        <div className='grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 m-5 p-3'>
                            <Image src={curtain1} alt='' width={200} className='m-2 rounded-md hover:scale-105 transition-transform cursor-pointer' />
                            <Image src={curtain2} alt='' width={200} className='m-2 rounded-md hover:scale-105 transition-transform cursor-pointer' />
                            <Image src={curtain3} alt='' width={200} className='m-2 rounded-md hover:scale-105 transition-transform cursor-pointer' />
                            <Image src={curtain4} alt='' width={200} className='m-2 rounded-md hover:scale-105 transition-transform cursor-pointer' />
                            <Image src={curtain5} alt='' width={200} className='m-2 rounded-md hover:scale-105 transition-transform cursor-pointer' />
                            <Image src={curtain6} alt='' width={200} className='m-2 rounded-md hover:scale-105 transition-transform cursor-pointer' />
                        </div>
                    ...
                    <div className='flex justify-between items-center'>
                        <div className='grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 m-5 p-3'>
                            <Image src={curtain7} alt='' width={200} className='m-2 rounded-md hover:scale-105 transition-transform cursor-pointer' />
                            <Image src={curtain8} alt='' width={200} className='m-2 rounded-md hover:scale-105 transition-transform cursor-pointer' />
                            <Image src={curtain9} alt='' width={200} className='m-2 rounded-md hover:scale-105 transition-transform cursor-pointer' />
                            <Image src={curtain10} alt='' width={200} className='m-2 rounded-md hover:scale-105 transition-transform cursor-pointer' />
                            <Image src={curtain11} alt='' width={200} className='m-2 rounded-md hover:scale-105 transition-transform cursor-pointer' />
                            <Image src={curtain12} alt='' width={200} className='m-2 rounded-md hover:scale-105 transition-transform cursor-pointer' />
                        </div>
                    ...
                    <div className='flex justify-between items-center'>
                        <div className='grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 m-5 p-3'>
                            <Image src={curtain13} alt='' width={200} className='m-2 rounded-md hover:scale-105 transition-transform cursor-pointer' />
                            <Image src={curtain14} alt='' width={200} className='m-2 rounded-md hover:scale-105 transition-transform cursor-pointer' />
                            <Image src={curtain15} alt='' width={200} className='m-2 rounded-md hover:scale-105 transition-transform cursor-pointer' />
                            <Image src={curtain16} alt='' width={200} className='m-2 rounded-md hover:scale-105 transition-transform cursor-pointer' />
                            <Image src={curtain17} alt='' width={200} className='m-2 rounded-md hover:scale-105 transition-transform cursor-pointer' />
                            <Image src={curtain18} alt='' width={200} className='m-2 rounded-md hover:scale-105 transition-transform cursor-pointer' />
                        </div>
                        <div className='hidden lg:flex'>
                    ...
                    <div className='flex justify-between items-center'>
                        <div className='grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 m-5 p-3'>
                            <Image src={curtain19} alt='' width={200} className='m-2 rounded-md hover:scale-105 transition-transform cursor-pointer' />
                            <Image src={curtain20} alt='' width={200} className='m-2 rounded-md hover:scale-105 transition-transform cursor-pointer' />
                            <Image src={curtain21} alt='' width={200} className='m-2 rounded-md hover:scale-105 transition-transform cursor-pointer' />
                            <Image src={curtain22} alt='' width={200} className='m-2 rounded-md hover:scale-105 transition-transform cursor-pointer' />
                            <Image src={curtain23} alt='' width={200} className='m-2 rounded-md hover:scale-105 transition-transform cursor-pointer' />
                            <Image src={curtain24} alt='' width={200} className='m-2 rounded-md hover:scale-105 transition-transform cursor-pointer' />
                        </div>
                        <div className='hidden lg:flex'>
